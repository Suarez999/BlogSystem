...
<script type="text/javascript">
	...
	var aaa= $("#aaa").val();
		...
		if(content == null || content == "") {
			...
			$.post(
				"${pageContext.request.contextPath}/comment/insert.action",
	...
	<div>
		...
		<div class="blog_info">
				...
				<c:choose>
					...
					<c:otherwise>
						<c:forEach items="${keyWords }" var="keyword">
							&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/blog/findByKeyword.action?keyword=${keyword }">${keyword }</a>&nbsp;
						</c:forEach>
					</c:otherwise>
				</c:choose>
			</div>
			<div style="float:right;">
				...
				』&nbsp;&nbsp; 博客类别：<a
					href="${pageContext.request.contextPath }/blog/findByType.action?type=${blog.blogType.typename }">${blog.blogType.typename }</a>&nbsp;&nbsp;
		...
		<div style="line-height:3; background-color: #F8F8FF">
			<font style="color:#8B2323">作者：xx&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;尊重博主原创文章，转载请注明文章出于此处。</font>
		</div>
...
<div class="data_list">
	<div class="data_list_title">
		...
		<c:if test="${fn:length(commentList) >10 }">
